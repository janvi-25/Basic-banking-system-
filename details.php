	 ...
	 <nav class="navbar navbar-inverse">
	  <div class="container-fluid">
	    ...
	    <ul class="nav navbar-nav">
	      <li ><a href="http://localhost/index.php">Homepage</a></li>
	      <li class="active"><a href="http://localhost/userinfo.php">View all customers</a></li>
	    </ul>
	  </div>
	</nav>
	<body>
						    ...
						    <div class="modal-content">
						      <div class="modal-header">
						        ...
						        <div class="modal-body">
						      	<div class="row">
								    <div class="col-sm-4" style="background-color:lightgreen;">Email:</div>
								    <div class="col-sm-8" style="background-color:lavenderblush;"><?php echo $row["Email"]; ?></div>
							    </div> 
						        <div class="row">
								    <div class="col-sm-4" style="background-color:lightgreen;">Mobile:</div>
								    <div class="col-sm-8" style="background-color:lavenderblush;"><?php echo $row["Mobile"]; ?></div>
								</div> 
						        <div class="row">
								    <div class="col-sm-4" style="background-color:lightgreen;">Balance:</div>
...
<div class="container" style="text-align: center;">
  ...
  <button type="button" class="btn btn-success" style="margin-bottom: 10px;"><a href="http://localhost/userinfo.php" style="text-decoration: none;color: #fff;font-size: 20px;">Transfer Money</a></button>    
</div>
