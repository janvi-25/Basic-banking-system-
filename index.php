...
<body>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a href="http://localhost/index.php">Homepage</a></li>
      <li><a href="http://localhost/details.php">View customers</a></li>
    </ul>
  </div>
</nav>
<h1 class="text-center" style="background-color: lavender; color:black">
Created by : Janvi Yadav</h1>
<div class="align1">
<h1 class="text-center ">             Welcome To My Indian Bank              </h1>
